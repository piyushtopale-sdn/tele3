...
@Component({
  selector: 'app-admin-all-request',
  templateUrl: './admin-all-request.component.html',
  styleUrls: ['./admin-all-request.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class AdminAllRequestComponent {
  ...
  exportManageTest() {
    ...
    let reqData = {
      ...
      toDate: this.toDate,
      serviceType: this.serviceType,
      labRadiologyId: this.selecteduser
