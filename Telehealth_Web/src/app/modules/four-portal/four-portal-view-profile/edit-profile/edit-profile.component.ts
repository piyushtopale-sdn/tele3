...
export class EditProfileComponent {
  ...
  constructor(
    ...
    private labimagingdentaloptical: FourPortalService,
  ...
  private uploadDocument(doc: FormData) {
    ...
    return new Promise((resolve, reject) => {
      this.labimagingdentaloptical.uploadFileForPortal(doc).subscribe({
        next: (result) => {
  ...
  routeBack(){
    this.route.navigate([`/portals/viewProfile/${this.userType}`]);
  }
