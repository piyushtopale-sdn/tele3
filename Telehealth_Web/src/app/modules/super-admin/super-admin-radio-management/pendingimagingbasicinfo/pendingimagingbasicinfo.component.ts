...
@Component({
  selector: 'app-pendingimagingbasicinfo',
  templateUrl: './pendingimagingbasicinfo.component.html',
  styleUrls: ['./pendingimagingbasicinfo.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PendingimagingbasicinfoComponent implements OnInit {
  ...
  routeToPermission(){
    this.route.navigate([`/super-admin/radiology/permission/${this.forPortalUserId}`])
  }
