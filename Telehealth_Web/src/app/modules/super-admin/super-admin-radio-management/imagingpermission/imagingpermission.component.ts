...
@Component({
  selector: 'app-imagingpermission',
  templateUrl: './imagingpermission.component.html',
  styleUrls: ['./imagingpermission.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ImagingpermissionComponent implements OnInit {
  ...
  handleAssignPerminssions() {
    ...
    this.service.asignMenuSubmit(reqData).subscribe(
      (res: any) => {
        ...
        this.route.navigate(["/super-admin/radiology"]);
      },
      (err) => {
        console.log(err);
      }
