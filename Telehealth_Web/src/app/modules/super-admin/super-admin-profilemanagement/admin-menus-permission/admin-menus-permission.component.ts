...
@Component({
  selector: 'app-admin-menus-permission',
  templateUrl: './admin-menus-permission.component.html',
  styleUrls: ['./admin-menus-permission.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class AdminMenusPermissionComponent {
  allMenus: any = [];
