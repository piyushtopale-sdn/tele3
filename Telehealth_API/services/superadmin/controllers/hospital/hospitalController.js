...
class HospitalController {
    ...
    //         }
    //         const getAllHospital = await httpService.get('hospital/list-hospital-admin-user', data, '', 'labradioServiceUrl');
    ...
    //     try {
    //         const result = await httpService.post('hospital/approve-or-reject-hospital', body, '', 'labradioServiceUrl');
    //         handleResponse(req, res, 200, {
    //             status: true,
    //             body: null,
    ...
    //         }
    //         const getHospitalAdminDetails = await httpService.get('hospital/view-hospital-admin-details', data, '', 'labradioServiceUrl');
    //         handleResponse(req, res, 200, {
    //             status: true,
