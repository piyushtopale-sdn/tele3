    ...
    try {
      ...
      if (result.length > 0) {
        ...
        if (result[0]?.personalDetails?.medicalInformation?.medicalHistory) {
          ...
          const paginatedMedicalHistory = limit == 0 ? medicalHistory : medicalHistory.slice((pageNumber - 1) * pageSize, pageNumber * pageSize);
        ...
        if (result[0]?.personalDetails?.medicalInformation?.socialHistory) {
          ...
          const paginatedSocialHistory = limit == 0 ? socialHistory : socialHistory.slice(
        ...
        if (result[0]?.familyDetails) {
          ...
          const paginatedFamilyHistory = limit == 0 ? familyHistory : familyHistory.slice(
              (pageNumber - 1) * pageSize,
              pageNumber * pageSize
          );
