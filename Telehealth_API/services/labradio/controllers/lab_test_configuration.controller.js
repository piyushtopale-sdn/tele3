...
//                 { labName: {$regex: searchText || '', $options: "i"} }
//             ]
//         }
...
//         if(labRadiologyId) {
//             center_filter = {
//                 labId: mongoose.Types.ObjectId(labRadiologyId)
//             }
//         }
...
// Get Lab Test Configuration List : 16/02/25
// export const getLabTestConfiguration = async (req, res) => {
//     try {
//         const { page, limit, searchText, sort, labRadiologyId } = req.query;
...
//         // Sorting
//         let fieldName = "for_portal_user.createdAt";
//         let sortOrder = -1;
//         if (sort) {
...
//         // Pagination
//         const skip = searchText ? 0 : (page - 1) * limit;
//         const limitNum = parseInt(limit, 10) || 0;

//         // Fetch Data
//         const testConfigurations = await LabTestConfiguration.find(query)
//             .populate({
//                 path: "labId",
//                 model: "PortalUser",
//                 select: "centre_name",
...
//         // Transform Data
//         const transformedResults = testConfigurations.map((test) => ({
//             _id: test._id,
//             labName: test.labId?.centre_name || "",
//             testName: test.testName,
//             testConfiguration: test.testConfiguration,
//             referenceRange: test.referenceRange,
//             alphaResult: test.alphaResult,
//             createdAt: test.createdAt,
//         }));

//         // Total Count
//         const totalCount = await LabTestConfiguration.countDocuments(query);
...
// export const getLabTestConfiguration = async (req, res) => {
//     try {
//         let { page, limit, searchText, sort, labRadiologyId } = req.query;
...
//         let center_filter = {};
//         if (labRadiologyId) {
//             center_filter = { labId: new mongoose.Types.ObjectId(labRadiologyId) };
//         }
...
export const getRadioTestById = async (req, res) => {
    try {
        ...
        //     getStudyType = await httpService.getStaging(`common-api/get-study-type-ById/${result[0].studyTypeId}`,  {}, headers, 'superadminServiceUrl');
        // }
